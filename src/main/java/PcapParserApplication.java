...
import result.AvgIntervalResult;
...
//        PcapParserUtils pcapParserUtils = PcapParserUtils.forPcap(input);
        ...
        try {
            ...
            PcapParserUtils pcapParserUtils1 = PcapParserUtils.forPcap("files/youtube/2021-12-20 20-51-40.pcap");
            List<AvgIntervalResult> intervalResults = pcapParserUtils1.generateAVGIntervalsAboveRateResults();
            PcapParserUtils.generateAverageTimesCsv(intervalResults);
